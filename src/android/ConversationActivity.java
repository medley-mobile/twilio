...
import static io.ionic.starter.R.drawable.ic_phonelink_ring_white_24dp;
import static io.ionic.starter.R.drawable.ic_volume_up_white_24dp;
 ...
 private void addRemoteParticipant(RemoteParticipant remoteParticipant) {
   ...
   private void addRemoteParticipantVideo(VideoTrack videoTrack) {
    ...
    private void removeRemoteParticipant(RemoteParticipant remoteParticipant) {
      ...
      videoStatusTextView.setText(remoteParticipant.getIdentity() + " left.");
      ...
      private Room.Listener roomListener() {
        return new Room.Listener() {
            ...
            public void onConnected(Room room) {
              ...
              videoStatusTextView.setText("Waiting.....");
